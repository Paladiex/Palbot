...
local loc1 = Location(731, 385)
local r1, g1, b1 = getColor(loc1)
local loc2 = Location(731, 384)
local r2, g2, b2 = getColor(loc2)
local loc3 = Location(696, 447)
local r3, g3, b3 = getColor(loc3)
local loc4 = Location(697, 447)
local r4, g4, b4 = getColor(loc4)
local loc5 = Location(661, 387)
local r5, g5, b5 = getColor(loc5)
local loc6 = Location(660, 387)
